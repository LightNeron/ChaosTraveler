...
public class ItemStacks {
    ...
    public static ItemStack ReloadConfig() {
        ItemStack ReloadConfig = new ItemStack(Material.CHAIN);
        ItemMeta ReloadConfigMeta = ReloadConfig.getItemMeta();
        ReloadConfigMeta.displayName(MiniMessage.miniMessage().deserialize("<#fff5bf>Перезагрузка конфигурации"));
